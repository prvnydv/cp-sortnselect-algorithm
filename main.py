...
def consolidated_score():
    ...
    output_folder_author = ''
    for permission in permissions:
        if permission['role'] == 'owner': output_folder_author = permission['emailAddress']
    ...
    number_of_output_images = math.ceil(0.25*len(url_array))
    job_uid = folder_name
    ...
    folder.Upload()
    destination_folder = drive.ListFile({"q": "mimeType='application/vnd.google-apps.folder' and trashed=false"}).GetList()[0]
